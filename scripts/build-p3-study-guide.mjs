...
<nav class="related" aria-label="Reload guides"><a href="../persona-3-reload-social-links/">Social Links and stat requirements</a> · <a href="../persona-3-reload-deadlines/">Rescue deadlines, requests and Linked Episodes</a></nav><p>${tracker}</p>
