...
for (const [slug, title, description, body] of [
  [slSlug, 'Persona 3 Reload Social Links | Requirements and schedules', 'Check all 22 Social Links, their introductions, social-stat gates and usual weekly schedules in Persona 3 Reload.', socialBody],
  [dlSlug, 'Persona 3 Reload deadlines | Rescues and requests', 'Check missing-person rescue windows, dated Elizabeth requests and Linked Episode dates in Persona 3 Reload.', deadlineBody],
]) {
