...
<nav class="related" aria-label="Reload guides"><a href="../persona-3-reload-school-answers/">School answers and exam requirements</a> · <a href="../${slSlug}/">Social Links and stat requirements</a> · <a href="../${dlSlug}/">Rescue deadlines, requests and Linked Episodes</a></nav><p>${tracker(slug)}</p>
