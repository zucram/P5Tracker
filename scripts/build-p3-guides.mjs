...
const tracker = slug => `<a class="cta" href="../../games/persona-3-reload/#planner" data-umami-event="guide_open_tracker" data-umami-event-guide="${slug}">Open the Reload planner</a>`;
...
<nav class="related" aria-label="Reload guides"><a href="../${slSlug}/">Social Links and stat requirements</a> · <a href="../${dlSlug}/">Rescue deadlines, requests and Linked Episodes</a></nav><p>${tracker(slug)}</p>
