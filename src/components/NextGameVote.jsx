...
export function NextGameVote() {
  ...
  return (
    <section className="mt-12 rounded-2xl border border-neutral-800 p-5" aria-labelledby="next-game-title">
      ...
      <p className="mt-2 text-sm text-neutral-300"><a className="text-sky-300 underline" href={`${import.meta.env.BASE_URL}p3/#calendar`}>Persona 3 Reload is available now. Open the monthly calendar.</a></p>
