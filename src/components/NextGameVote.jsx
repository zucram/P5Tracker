...
const GAMES = ['Persona 3 Reload', 'Persona 4 Golden', 'Persona 5', 'Metaphor: ReFantazio', 'Another Persona edition'];
...
export function NextGameVote() {
  ...
  return (
    <section className="mt-12 rounded-2xl border border-neutral-800 p-5" aria-labelledby="next-game-title">
      ...
      <p className="mt-2 text-sm text-neutral-400">We are exploring more Persona games and Metaphor. These trackers are not available yet. Suggestions use Umami analytics.</p>
